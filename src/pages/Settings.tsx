...
export default function Settings() {
    ...
    const { currency, setCurrency, convertToDisplay, convertToBeSaved } = useCurrency();
                        ...
                        <CardContent>
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <div className="w-[180px]">
                                    <Input
                                        type="number"
                                        value={monthlyBudget > 0 ? convertToDisplay(monthlyBudget).toFixed(2) : ''}
                                        onChange={(e) => {
                                            const val = Number(e.target.value);
                                            setMonthlyBudget(convertToBeSaved(val));
                                        }}
                                        placeholder="0.00"
                                    />
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            a.href = url;
                                            a.download = `spendwise_backup_${new Date().toISOString().split("T")[0]
                                                }.json`;
