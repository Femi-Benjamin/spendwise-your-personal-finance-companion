                ...
                <div className="space-y-6">
                        ...
                        <CardContent>
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    ...
                                    <div className="text-sm text-muted-foreground">Select how amounts are displayed</div>
                                </div>
                        ...
                        <CardContent>
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-0.5 flex-1">
                                    ...
                                    <div className="text-sm text-muted-foreground">Enter 0 to disable budget tracking</div>
                                </div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    <Label htmlFor="trend-chart-toggle">Show Spending Trend</Label>
                                    <div className="text-sm text-muted-foreground">Display daily spending trend chart</div>
                                </div>
                                <Switch
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-xs text-muted-foreground">Download all your expenses as a JSON file.</p>
                                    </div>
                                    <Button variant="outline" size="sm" className="gap-2" onClick={() => {
                                        const data = localStorage.getItem("spendwise_local_expenses");
                                        if (!data) {
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-xs text-muted-foreground">Restore your expenses from a backup file.</p>
                                    </div>
                                                ...
                                                reader.onload = (event) => {
                                                    try {
                                                        ...
                                                        if (Array.isArray(parsed)) {
                                                            localStorage.setItem("spendwise_local_expenses", JSON.stringify(parsed));
